"""RI-1 Shadow Observation Runner — batch shadow pipeline execution.
...
Usage:
    python scripts/ri1_shadow_observation.py
"""
...
SCENARIOS = [
    ...
    },
    {
        ...
        "scenario": "crypto_defi_qual_fail",
    },
    {
        "symbol": "FET/USDT",
        "ac": AssetClass.CRYPTO,
...
def run_observation() -> ObservationSummary:
    ...
    return ObservationSummary(
        run_id=f"RI1-OBS-{run_ts.strftime('%Y%m%d-%H%M%S')}",
...
def main():
    ...
    print("=" * 70)
    print(f"  RI-1 Shadow Observation Run: {summary.run_id}")
    print("=" * 70)
    print()
