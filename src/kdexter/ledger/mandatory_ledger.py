...
_ALL_ITEMS: list[MandatoryItem] = [
    MandatoryItem("M-01", "clarify", "실행 전 의도 명확화", "CLARIFYING", None, None, "L4", "B2"),
    MandatoryItem("M-02", "spec twin", "스펙 쌍 생성", "SPEC_READY", None, None, "L4", "B2"),
    MandatoryItem("M-03", "risk check", "리스크 검사", "PLANNING", "G-03", None, "L3", "B1"),
    MandatoryItem("M-04", "security check", "보안 검사", "PLANNING", "G-04", None, "L3", "B1"),
    MandatoryItem("M-05", "rollback plan", "롤백 계획", "PLANNING", "G-02", None, "L26", "A"),
    MandatoryItem(
        "M-06", "recovery simulation", "복구 시뮬레이션", "PLANNING", "G-02", None, "L26", "A"
    ),
    MandatoryItem("M-07", "evidence", "모든 변경에 증거 첨부", None, "G-05", None, "L10", "A"),
    MandatoryItem("M-08", "budget check", "예산 한도 확인", "VALIDATING", "G-22", 7, "L29", "B2"),
    MandatoryItem("M-09", "compliance check", "준수율 검사", "VALIDATING", "G-04", 3, "L13", "B2"),
    MandatoryItem("M-10", "provenance", "출처 기록", None, "G-18", None, "L12", "B2"),
    MandatoryItem("M-11", "drift check", "의도 이탈 감지", "VALIDATING", "G-19", 4, "L15", "B2"),
    MandatoryItem("M-12", "conflict check", "규칙 충돌 검사", "VALIDATING", "G-20", 5, "L16", "B2"),
    MandatoryItem("M-13", "pattern check", "실패 패턴 대조", "VALIDATING", "G-21", 6, "L17", "B2"),
    MandatoryItem("M-14", "trust refresh", "신뢰 상태 갱신", "VALIDATING", "G-23", 8, "L19", "B2"),
    MandatoryItem(
        "M-15", "loop health", "루프 건강 상태 확인", "VALIDATING", "G-24", 9, "L28", "B2"
    ),
    MandatoryItem("M-16", "completion check", "완성 검증", "VERIFY", "G-25", None, "L21", "B2"),
    MandatoryItem(
        "M-17", "spec lock check", "스펙 잠금 확인", "VALIDATING", "G-26", 10, "L22", "B1"
    ),
    MandatoryItem("M-18", "research", "변경 전 리서치", "PLANNING", "G-27", None, "L23", "B2"),
]
...
class MandatoryLedger:
    ...
    def list_unsatisfied(
        ...
        return [item for item in required if not self.check_satisfied(item.item_id, ctx)]
