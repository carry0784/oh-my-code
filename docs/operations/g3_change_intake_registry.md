...
| CR-038 | 2026-04-01 | A | Phase 1: 데이터 수집 계층 확장 (자가진화형 시스템 기반) | C | A+B | approved | (구현 중) | 신규 모듈 7개: market_data_collector, sentiment_collector, indicator_calculator, market_state_builder, MarketState model, data_collection_tasks, tests. 기존 실행 경로 변경 0건, dry_run 기본값 유지 |
