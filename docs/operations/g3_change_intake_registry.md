...
| CR-039 | 2026-04-01 | A | Phase 2: Regime Detection + 분석 엔진 (자가진화형 시스템) | C | A+B | **SEALED** | commit c1623ee | SEALED: 7 신규 + 2 수정, 48 tests, 3281/0/0 PASS, ML regime detector + market scorer + time-series analyzer + API 3 endpoints, 실행 경로 변경 0건 |
| CR-040 | 2026-04-01 | A | Phase 3: 백테스팅 + 검증 파이프라인 (자가진화형 시스템) | C | A+B | **SEALED** | commit 1548d9e | SEALED: 9 신규 + 1 수정, 38 tests, 3313/0/0 PASS, backtest engine + performance metrics + walk-forward + Monte Carlo + 5-stage pipeline, 실행 경로 변경 0건 |
| CR-041 | 2026-04-01 | A | Phase 4: Strategy Runner + Auto Pipeline (자가진화형 시스템) | C | A+B | **SEALED** | 4 서비스 + 40 테스트 | 신규: strategy_genome, fitness_function, strategy_tournament, strategy_runner. 기존 실행 경로 변경 0건. 3353 tests PASS |
| CR-042 | 2026-04-01 | A | Phase 5: Advanced Strategy Evolution Engine (자가진화형 시스템) | C | A+B | **SEALED** | 6 서비스 + 38 테스트 | 신규: adaptive_mutation, island_model, regime_evolution, evolution_state, strategy_registry, advanced_runner. 기존 실행 경로 변경 0건. 3454 tests PASS |
| CR-043 | 2026-04-01 | A | Phase 6: Portfolio Optimization + Scale (자가진화형 시스템) | C | A+B | **SEALED** | 5 서비스 + 30 테스트 | 신규: portfolio_optimizer, risk_budget_allocator, correlation_analyzer, portfolio_metrics, portfolio_constructor. 기존 실행 경로 변경 0건. 3454 tests PASS |
| CR-044 | 2026-04-01 | A | Phase 7: Full Autonomous Loop (자가진화형 시스템) | C | A+B | **SEALED** | 5 서비스 + 34 테스트 | 신규: autonomous_orchestrator, paper_trading_bridge, strategy_lifecycle, system_health, governance_gate. 기존 실행 경로 변경 0건. 3454 tests PASS |
