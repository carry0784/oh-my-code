...
| MA-07 | 5줄 요약 게이트 기입 | PR 하단 "Merge 직전 5줄 요약 게이트" 5항목 전체 기입, merge 가능 여부 = `가능` |

> **MA-07 위반 시**: "Merge 직전 5줄 요약 게이트"가 미기입이거나 merge 가능 여부가 `불가`인 PR은 MB-01과 동일하게 merge를 금지한다.
