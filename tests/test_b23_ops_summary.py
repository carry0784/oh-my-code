...
class TestOpsSafetySummaryEndpoint:
    ...
    def test_schema_has_extended_fields(self):
        ...
        required = {
            'timestamp', 'preflight_decision', 'gate_decision', 'approval_decision',
            'all_clear', 'blocked_reasons', 'next_safe_steps',
            'pipeline_state', 'ops_score', 'policy_decision',
            'lockdown_state', 'trading_authorized', 'check_grade', 'conditions_met',
            'preflight_evidence_id', 'gate_evidence_id', 'approval_id', 'safety_note',
        }
